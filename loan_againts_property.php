    ...
    <div style=" background: linear-gradient(to right, #a8ddff, #6dd5fa, #ffffff); padding: 30px;">
        <div class="container">
            <div class="row">
                ...
                <img src="img/house_property.png" alt="" width="100%">
                </div>
            </div>
        </div>
    </div>
        ...
        <div style="background: linear-gradient(to right, #86a8e7, #91eae4); padding: 20px; border: 1px solid rgb(219, 209, 209); border-radius: 10px;" id="card" data-aos="flip-left">
            ...
            <ul>
                <li>The title of the property needs to be clear and marketable. Your bank lends an amount equal to about
                    50-60% of the value of the pledged property.</li>

                <li>Architects, chartered accountants, cost accountants, company secretaries, doctors, engineers,
                    dentists and top management professionals can easily avail loan against property.</li>

                <li>You can avail loan against property for self-occupied residential properties or even if you have
                    rented it out to a tenant. LAP can be availed against an empty plot of land. </li>

                <li>If you are salaried, you need to have a minimum age of 21-24 years and your maximum age can be
                    around 60 years at maturity of the loan. </li>

                <li>If you are self employed, your maximum age can be 65 years at the maturity of the loan.</li>

                <li>You need to have a minimum work experience of 1-5 years if you are salaried, and you need to be in
                    business for at least 2-5 years if you are self employed.</li>

                <li>Past credit history plays a very important role in getting your loan against property sanctioned.
                </li>

                <li>The CIBIL score plays a very important part and if you’re past credit history is poor, your loan is
                    liable to get rejected.</li>

                <li>Loan against property can be availed on land/property which has multiple owners. All co-owners must
                    be co-applicants for the loan.</li>

                <li>Loan against property can be availed against a commercial property.</li>

                <li>If property mortgaged is under-construction, the bank will disburse loan amounts is installments.
                    Interest will be charged only on the amount which has been disbursed. This is called the pre-EMI.
                    After full loan has been disbursed,
                    you have to pay regular EMI’s.</li>
