        ...
        <div class="container-fluid" data-aos="fade-up">
            <div class="row about-cols">
                ...
                <div class="col-md-7 col-sm-6 text-center" data-aos="fade-up" data-aos-delay="100">
                    <div class="about-col">
                        <img src="img/term4.png" alt="" width="60%">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 text-center" data-aos="zoom-in-up">
                    <img src="img/term3.png" alt="" width="90%">
                </div>
    ...
    <div style="background: linear-gradient(to right,#ffffff, #edd37b); padding: 30px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 text-center" data-aos="zoom-in-left"> <img src="img/term2.png" alt="" width="60%"></div>
            </div>
        </div>
    </div>
                ...
                <div class="col-sm-3">
                    <div class="card">
                        ...
                        <div class="container"><br>
                            ...
                            <p>The premium for a basic accident plan or even a comprehensive accident plan is very low.
                            </p>
                        </div>
                    </div>
                </div>
