            ...
            <div class="tab-content">
                <div class="tab-pane active show" id="tab-1">
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="https://image.freepik.com/free-vector/powder-holi-paints-frame-border-solated_1441-3793.jpg"
                                alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="tab-2">
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="https://image.freepik.com/free-vector/empty-illuminated-podium-realistic_1441-3744.jpg"
                                alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="tab-3">
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="https://image.freepik.com/free-photo/explosion-colored-powder-white-background_1112-1555.jpg"
                                alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="tab-4">
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="https://image.freepik.com/free-vector/collection-tree-isolated-white-background_64749-96.jpg"
                                alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
