...
<main id="main">
            ...
            <div class="row about-cols">
                ...
                <div class="col-md-5 col-sm-6 text-center" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <section id="contact" style="background-color: white; border-radius: 10px;" id="card">
                        <h4 style="font-weight: bold;"><span style="color: black;">Get The Right Advice on<br>Accidental Insurance Plan
                                </span></h4>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 text-center">
                    <img src="img/accident_inc.png" alt=""
                        width="70%">
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div style="background: linear-gradient(to right, #1fa2ff, #12d8fa, #a6ffcb); padding: 30px;">
            <div class="row">
                <div class="col-sm-6 text-center">
                    <img src="img/accident_inc(2).png" alt=""
                        width="100%">
                </div>
                <div class="col-sm-6">
        ...
        <div id="card"
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="container"><br>
                            <h6><b>The Plan is Cheap
                                </b></h6>
                            <p>The premium for a basic accident plan or even a comprehensive accident plan is very
                                low.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="container"><br>
                            ...
                            <p>There are special accident plans available to high risk workers, who work in mines,
                                oil
        ...
        <div id="card"
            ...
            <ul>
                <li>A the term itself suggests, a Group Accident Policy is not meant for individuals. It is taken by
                    employers for their employees. Depending on the group size, discount on premium may be offered.
                    It
                    is a good value added benefit for small
                    organizations and is available at a low cost. However, this is very basic cover and may not
                    offer
        ...
        <div id="card"
            ...
            <ul>
                <li>The insurer must be informed about the accident as soon as possible. The insurer may also be
                    informed while the insured is on the way to the hospital. In order to show proof that the claim
                    has
